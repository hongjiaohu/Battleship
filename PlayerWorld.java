...
public class PlayerWorld extends World
{
    ...
    public PlayerWorld()
    {    
        // Create a new world with 720*720 cells with a cell size of 1x1 pixels.
        super(720, 720, 1); 
    ...
    /**
     * drawLine draws the 10*10 grid that we can place our ships inside fpr the game Battleship
     * 
     * @parame There are no parameters
     * @return no returned
     * 
    ...
    /**
     * checkShip checks waht ship is to be added to the grid next
     * 
     * @parame There are no parameters
    ...
    /**
     * fillBoard fills the numeric representation of the gameBoard with 1's where a ship is locate
     * 
     * @parame There are no parameters
     * @return no returned 
     */
    ...
    /**
     * displayBoard displays the new numerical representation of the gameboard where 1's indicate that a ship was placed at that location and 0's indicate that no ship is at that location
     * 
     * @parame There are no parameters
     * @return no returned 
     */
